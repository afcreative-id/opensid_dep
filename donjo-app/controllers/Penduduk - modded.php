...
class Penduduk extends Admin_Controller {
  ...
  public function get_penduduk_detail() {
    $nik         =  $this->input->get('nik', TRUE);
    $end_point   = 'http://103.212.211.11/backend/getpenduduk.php?nik=' . $nik . '&key=Ax568lo6BKSTgYR';
    $output      = @file_get_contents($end_point);
