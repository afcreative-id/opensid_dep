<h4 class="title-tag"><?= 'Galeri Album : ' . $parrent["nama"]; ?></h4>
<div id='post'>
	<?php $i = 1 ?>
...
<div id='paginator'>
	<?php if ($paging->prev) : ?>
		<span class='newer'>
			<a href='<?= site_url("first/sub_gallery/{$parrent['id']}/{$paging->prev}"); ?>' title='Artikel Terbaru'><i class='fa'>&#xf104;</i></a>
		</span>
	<?php endif; ?>
	<?php if ($paging->next) : ?>
		<span class='older'>
			<a href='<?= site_url("first/sub_gallery/{$parrent['id']}/{$paging->next}"); ?>' title='Artikel Terlama'><i class='fa'>&#xf105;</i></a>
		</span>
	<?php endif; ?>
</div>
<div class='clear'></div>